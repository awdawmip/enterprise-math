...
`npm run check` runs the real Durable Object state-machine tests, the static
control contract, and a Wrangler dry-run build.
...
OWNER_STATE_AND_AUDIT_AND_ALARM_UPDATE -> ONE STORAGE TRANSACTION

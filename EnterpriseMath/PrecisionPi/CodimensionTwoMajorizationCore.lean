...
namespace EnterpriseMath.PrecisionPi.CodimensionTwoMajorizationCore
...
/-- Paper-I/Paper-II range: strict gap at every proper prefix and equality at
full length. -/
...
end EnterpriseMath.PrecisionPi.CodimensionTwoMajorizationCore

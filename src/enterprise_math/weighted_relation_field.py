"""Capacity-weighted integer relation fields for A3 structured relation-state algebra.

Semantic replay from the historical relation-quotient branch.  For blocks with
positive capacities ``m_i`` and integer totals ``c_i`` define

...
For each represented depth at one collapse factor:

* SCALAR_DEPTH suffices when x, y, and corner returned budgets all agree;
* ACTIVE_COUNT suffices when x and y agree, while corner may differ;
* ACTIVE_SET is required when x and y differ.

Only depths reachable at the declared collapse factor are tested.  This is an
E001 finite specialization of future-language-relative state retention.
"""

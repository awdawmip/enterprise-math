"""Coordinate-free finite causal-boundary helpers for Enterprise Math P021.
...
This program-specific layer consumes the existing finite observation/refinement
machinery; it does not define a second generic precision calculus.
"""

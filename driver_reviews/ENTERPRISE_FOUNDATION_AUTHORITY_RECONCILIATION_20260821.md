...
- `O_E=0`;
- origin is a triple circle-cell boundary intersection, not a cell center/cell;
- overlapping circle cells, nearest-center spacing `1`, cell radius `1/sqrt(3)`;
- exactly three positive native rays;

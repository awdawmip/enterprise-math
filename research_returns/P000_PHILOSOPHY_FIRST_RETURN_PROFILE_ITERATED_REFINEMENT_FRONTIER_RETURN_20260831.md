...
5. the exact representability image sizes on that prefix are `2, 3, 10, 20, 59, 147`;
...
The minimum partition-stabilization indices of the two witnesses are also different: `H_9` is `2`, while `G_9` is `1`.

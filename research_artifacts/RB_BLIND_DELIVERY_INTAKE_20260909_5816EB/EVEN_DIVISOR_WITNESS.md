...
Author of this audit witness: Driver `EM-DVR-5816EB`. Status: exact polynomial identity checked; the following paper argument awaits a separate non-author review. This is source-exposed review, not a blind reconstruction.
...
Target of the criticism: `exact_reduction.six_block_obstruction` in the raw freeze at `c73816d3552b4247861e12e476101e94a4a2ce5a`, not the later concrete source-exposed map. The original checker checks arithmetic/j values and does not prove the claimed exhaustive even-divisor classification.

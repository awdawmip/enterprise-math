...
flowchart TB
  ...
  RB_SOURCE_EXPOSED_EXACT_MAP["RB authorized full-ODE checkpoint; task INCOMPLETE"]
  A3 -->|"CONSUMES"| A4
  BRC -->|"CONSUMES"| A4
...
| **RB_SOURCE_EXPOSED_EXACT_MAP — RB authorized full-ODE checkpoint; task INCOMPLETE**<br>RS-RB-CM24-SOURCE-EXPOSED-EXACT-MAP-CERTIFICATE / TP2-554AC43234E8E297A6E9. A separately published CONTINUATION for one pinned restored formula, explicitly SOURCE_EXPOSED / NONBLIND_DISCLOSED; it does not reopen the blind classification or cover all surviving families.<br>[S113](#source-s113), [S114](#source-s114), [S115](#source-s115), [S116](#source-s116), [S117](#source-s117), [S119](#source-s119), [S120](#source-s120), [S121](#source-s121), [S122](#source-s122), [S123](#source-s123), [S124](#source-s124), [S125](#source-s125), [S126](#source-s126) | The executed identity_v1 integer-polynomial checker returned an empty remainder for the complete cleared frozen ODE, without critical-divisor substitution: FULL_FUNCTION_FIELD_ODE_CLEARED_IDENTITY_PASS. The stated rational Y gives a conditional target-equation consequence; nonzero/embedding proof is still required. This is one identity checkpoint, not a degree-six map certificate, an unsquared differential proof or full-task completion. | No Lean proof or formalized exact-map result is claimed. | The published canonical authorize receipt recorded CURRENT_AUTHORIZED_WINNING_ISSUE_240_CLAIM for comment 5593861263 and ER-BDAB13EB167775B80BE7 at 2026-09-09 00:32:37 UTC. The actual identity_v1 run then exited 0 at 00:43:07 UTC, linked to that authorization and certificate by SHA256. The program records integer coefficient operations and algebraic relation rewrites; BRC evaluations, integer divisions and root evaluations are all zero. T0/T6 lookup remains contract-level reuse, not a claim of native mathematical execution. This map only consumes the recorded receipts and grants no current lease authority. | The taskbook and TP2-554AC43234E8E297A6E9 remain published in main 3a00ea191ad0380bf341af746a825e0b0c474874; activity RA-81196A3A34AE5695CB527CFF and the ER were separately persisted to main. The four identity_v1 checkpoint, certificate, run and authorization sources are immutable at source commit 341f36bb53c25d97c3ae533a71c92ad273a7b904. PR1426 is draft and main intake is pending at this checkpoint; publication on the research branch is not main acceptance. | The previous blind stage retains its TASK-scoped ACCEPTED/ARCHIVE disposition. The new exact-map checkpoint explicitly remains INCOMPLETE with no formal Result or Driver acceptance. A local identity PASS does not grant full-task PASS, Working Truth, an API, Foundation promotion or parent closure; source exposure is not blind verification. |
...
| Existing mathematical frontier | RB_SOURCE_EXPOSED_EXACT_MAP | RB_CM24_PINNED_SOURCE_EXACT_MAP_CERTIFIED_OR_EXACT_FAILURE remains OPEN / INCOMPLETE. Still required: field/embedding nonzero certificates; all special-fiber valuations and square-class placement/descent; every common-basepoint cancellation and both degree-six claims, for descended X and for D to E; exact target j/model relation; unsquared differential with Y/sign/embedding and exceptional-point regularity; independent counterchecks and full proof/return. Period integer/homology index, independent absolute period ratio and the all-1980 parameter-family classification remain separate OPEN parent gaps. | Continue the existing task under valid current execution bindings from the frozen identity_v1 frontier, preserving its sources and every failure. Complete the remaining exact gates or report a named obstruction; include unsquared sign and tamper checks and keep INCOMPLETE while any gate is unresolved. Main intake and formal review remain separate from the recorded identity run. Do not restart blind classification or infer family or period closure. |

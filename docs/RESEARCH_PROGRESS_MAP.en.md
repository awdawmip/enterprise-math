...
flowchart TB
  ...
  RB_SOURCE_EXPOSED_EXACT_MAP["RB source-exposed exact-map task: registered"]
  A3 -->|"CONSUMES"| A4
  BRC -->|"CONSUMES"| A4
...
| **RB_SOURCE_EXPOSED_EXACT_MAP — RB source-exposed exact-map task: registered**<br>RS-RB-CM24-SOURCE-EXPOSED-EXACT-MAP-CERTIFICATE / TP2-554AC43234E8E297A6E9. A separately published CONTINUATION for one pinned restored formula, explicitly SOURCE_EXPOSED / NONBLIND_DISCLOSED; it does not reopen the blind classification or cover all surviving families.<br>[S113](#source-s113), [S114](#source-s114), [S115](#source-s115), [S116](#source-s116), [S117](#source-s117), [S119](#source-s119), [S120](#source-s120), [S121](#source-s121), [S122](#source-s122) | This is a required certificate, not a new proved result: bind the four special fibers and divisor/square-class placement; resolve every common basepoint; prove degree six for descended X and for D to E in the correct function-field senses; verify target equation/j, the complete frozen ODE and the unsquared pullback differential including Y/sign/embedding and exceptional points. Every gate is required; a degree-only or squared-identity checkpoint cannot be PASS. | No Lean proof or formalized exact-map result is claimed. | Registered at the publication checkpoint, awaiting execution evidence. This map has not adopted a new claim, ER or mathematical run receipt. T0/T6 are used only as task-contract typing and observation-preservation constraints; lookup is not execution, and positive counts do not replace complex coefficients, square classes or branch signs. | TP2-554AC43234E8E297A6E9 was published at 2026-09-08T23:55:43.753227+00:00 through DFU-AE59D6971E88DE79B661, with the exact taskbook, in main commit 3a00ea191ad0380bf341af746a825e0b0c474874. Generation 1 is claimable=true and owner=taskbook/unassigned at publication. Registration is not evidence of execution or current runtime authority. | The previous stage has a valid ACCEPTED/ARCHIVE review and this separate question has been published. That disposition is not a Result or acceptance for the new task. No successor mathematical PASS, Working Truth, API, Foundation promotion or parent closure is claimed. |
...
| Existing mathematical frontier | RB_SOURCE_EXPOSED_EXACT_MAP | RB_CM24_PINNED_SOURCE_EXACT_MAP_CERTIFIED_OR_EXACT_FAILURE remains OPEN at this registered checkpoint. Historical formula and replay claims must be checked under the declared exact embedding. Period integer/homology index, independent absolute period ratio and all-1980 classification remain separate OPEN parent gaps, not additional registered tasks. | After valid execution bindings, freeze the source and field embedding as data, locate the special fibers in the frozen classification and produce all hard-target gates or an exact named obstruction. Preserve failures and return INCOMPLETE for any unresolved gate; do not substitute a partial certificate or retrospective blindness. |

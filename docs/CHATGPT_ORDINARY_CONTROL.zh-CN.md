...
Protocol: `EM_CHAT_CONTROL_V1` · English: [CHATGPT_ORDINARY_CONTROL.md](CHATGPT_ORDINARY_CONTROL.en.md)
...
| `dispatch` | 无 | `kind`: `RESEARCH`（默认）、`GOVERNANCE`、`ANY`；现行 Chat payload 不接受 priority |

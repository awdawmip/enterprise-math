# Precision Calculus — Supplement 12
...
## 4. P018-T110 — Two-basin quotient transport
...
T110 says every element of this interval has square-root index `j` or `j+1`.
...
only says that division reduces magnitude. T110 says more:
...
T110 changes the status of the lower-band problem discovered in P017.

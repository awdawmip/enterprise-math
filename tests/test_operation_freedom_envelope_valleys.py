...
class OperationFreedomEnvelopeValleysTests(unittest.TestCase):
    ...
    def test_true_and_ideal_giant_sizes_stay_close_on_broad_finite_range(self):
        # This is regression evidence only.  The PR analytic argument gives the
        # asymptotic O(1) localization; the executable theorem merely records
        # the observed exact integer windows without floating-point e.

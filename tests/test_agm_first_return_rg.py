...
def test_zero_shape_degenerates_exactly() -> None:
    assert quadratic_universality_bounds(Fraction(0)) == (Fraction(0), Fraction(0))
    assert finite_shape_update(Fraction(0), 1) == 0

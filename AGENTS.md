...
- mathematical FQ research must run on a compatible L1/L2/L3 `RESEARCH` task; steward verification/integration runs on `GOVERNANCE`, never by pretending the steward owns the theorem research;

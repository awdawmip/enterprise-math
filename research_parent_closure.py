...
This reducer does not grant PRE_FINAL permission. It answers the narrower control
question that PRE_FINAL needs: whether the current operational Objective head is
CLOSED *and* every currently active child task under that Objective has
...
import research_objective_authority  # noqa: E402
